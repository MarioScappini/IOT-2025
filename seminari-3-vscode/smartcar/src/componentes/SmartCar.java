...
public class SmartCar {
    ...
    public void setSmartCartType(SmartCarType type){
        this.smartCarActiveEmergency = emergency;
    }

    public boolean getActiveEmergencyFlag(){
        return this.smartCarActiveEmergency;
    }
    ...
    public void publishVehicleOut() {
        ...
        // TODO: create an id and a timestamp for this
        String payload = "{\n" +
            "  \"id\":\"VEHICLE_OUT\",\n" +
            "  \"type\":\"EMERGENCY\",\n" +
